#!/usr/bin/env bash
# ARIP GraphRAG 웹 UI → Google Cloud Run 배포 스크립트
#
# 사전조건:
...
put_secret arip-llm-api-key    "$LLM_API_KEY"
put_secret arip-qdrant-api-key "$QDRANT_API_KEY"
put_secret arip-neo4j-password "$NEO4J_PASSWORD"
